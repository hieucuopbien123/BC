...
//Fork mainnet bằng ganache unlock account của USDC_WHALE thông qua url infura mainnet và networkId set cho giá trị
//ta mong muốn, set cái mainnet fork này trong config truffle
//chạy truffle test trên mainnet fork đó

//Kết quả ta lấy phụ thuộc vào decimals của các đồng như nào, vì USDC chỉ có 6 decimals nên chia 10^6 ở kết quả
//mới ra giá trị thực tế nhận